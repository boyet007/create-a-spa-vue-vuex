                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <template v-else>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" role="button" id="navbarDropdown" data-toggle="dropdown" 
                                class="nav-link dropdown-toggle" aria-exapanded="false" 
                                aria-haspopup="true">
                                {{ currentUser.name }} <span class="caret"></span>    
                            </a>
                            <a aria-labelledby="navbarDropDown" class="dropdown-menu">
